...
def download_all_songs(album_url):
    ...
    try:
        ...
        print(f"All songs from the album '{album_title}' have been successfully downloaded!")
...
if __name__ == "__main__":
    album_url = "https://www.torrenet.xyz/spotycai/album/79/Miguel+%C3%81ngel+Garc%C3%ADa+Arg%C3%BCez+(Chapa)/Los+Doce"
